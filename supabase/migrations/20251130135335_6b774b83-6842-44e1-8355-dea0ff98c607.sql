-- Fix aggregate_customer_profile function to properly merge v_engagement with v_project_engagement
...
BEGIN
  ...
  -- Update customer_profiles with MERGED engagement data (v_engagement + v_project_engagement)
  UPDATE public.customer_profiles
  SET 
    engagement_data = COALESCE(v_engagement, '{}'::jsonb) || COALESCE(v_project_engagement, '{}'::jsonb),
